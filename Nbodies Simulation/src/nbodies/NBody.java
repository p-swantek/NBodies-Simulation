...
/**
 * Simulates N particles in a plane, particles move due to the gravitational forces mutually affecting each particle as demonstrated by Sir Issac Newton's Law of Universal Graviation.
 * Takes in 3 command line arguments: the length of the simulation, the size of a time step in the simulation, and a text file containing planetary data from which to build the universe
 * for the simulation.  Theme from 2001: A Space Odyssey plays during the simulation
 * 
...
public final class NBody {
	...
	/**
	 * Draw the universe that is being simulated using StdDraw API. Draw the N particles and make the background a space image. Use the radius 
	 * of the universe to scale the canvas
	 * 
