...
/**
 * Data type that represents a particle in the universe.  The movement of this particle will be determined by the net gravitational forces acting upon it from other particles
 * within the universe
 * 
...
public final class Planet {
	...
	public double calcPairwiseForce(Planet other){
		...
		return getGravitationalForce(getMass(), other.getMass(), calcDistance(other)); //calculate the gravitational force between the two planets
	...
	/*
	 * Calculates and sets the net force amount in the x and y directions for this planet based on the gravitational forces acting upon it from other planets
	 */
	...
	public String toString() {
		...
		return String.format("Planet: %s, XVelocity: %f, YVelocity: %f, XAcceleration: %f, YAcceleration: %f, Mass: %f, PosX: %f, PosY: %f", getImg(), getXVelocity(), 
								getYVelocity(), getXAccel(), getYAccel(), getMass(), getX(), getY());
